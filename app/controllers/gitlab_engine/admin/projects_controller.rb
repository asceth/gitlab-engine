module GitlabEngine
  class Admin::ProjectsController < GitlabEngine::ApplicationController
    ...
    def team_update
      ...
      redirect_to gitlab_engine.admin_project_url(@admin_project), notice: 'Project was successfully updated.'
    end
    ...
    def create
      ...
      if @admin_project.save
        redirect_to gitlab_engine.admin_project_url(@admin_project), notice: 'Project was successfully created.'
      else
        render :action => "new"
      end
    end
