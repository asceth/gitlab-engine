...
describe Project do
  ...
  it "should return valid url to repo" do
    ...
    project.url_to_repo.should == GitlabEngine::Gitlab.config.ssh_path + "somewhere.git"
  end
  ...
  it "returns the full web URL for this repo" do
    ...
    project.web_url.should == "#{GitlabEngine::Gitlab.config.url}/somewhere"
  end
  ...
  describe "fresh commits" do
    ...
    it { project.fresh_commits.last.id.should == "c4f7d65274fc151774702cee2ad9c10b28cf742f" }
  end
