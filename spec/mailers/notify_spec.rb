...
describe GitlabEngine::Notify do
  ...
  describe 'for new users, the email' do
    ...
    subject { GitlabEngine::Notify.new_user_email(new_user.id, new_user.password) }
  ...
  context 'for a project' do
    describe 'items that are assignable, the email' do
      ...
      context 'for issues' do
        ...
        describe 'that are new' do
          subject { GitlabEngine::Notify.new_issue_email(issue.id) }
        ...
        describe 'that have been reassigned' do
          ...
          subject { GitlabEngine::Notify.reassigned_issue_email(recipient.id, issue.id, previous_assignee.id) }
      ...
      context 'for merge requests' do
        ...
        describe 'that are new' do
          subject { GitlabEngine::Notify.new_merge_request_email(merge_request.id) }
        ...
        describe 'that are reassigned' do
          ...
          subject { GitlabEngine::Notify.reassigned_merge_request_email(recipient.id, merge_request.id, previous_assignee.id) }
    ...
    context 'items that are noteable, the email for a note' do
      ...
      describe 'on a project wall' do
        ...
        subject { GitlabEngine::Notify.note_wall_email(recipient.id, note.id) }
      ...
      describe 'on a commit' do
        ...
        subject { GitlabEngine::Notify.note_commit_email(recipient.id, note.id) }
      ...
      describe 'on a merge request' do
        ...
        subject { GitlabEngine::Notify.note_merge_request_email(recipient.id, note.id) }
      ...
      describe 'on an issue' do
        ...
        subject { GitlabEngine::Notify.note_issue_email(recipient.id, note.id) }
